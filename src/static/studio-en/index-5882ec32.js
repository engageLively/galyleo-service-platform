System.register(['./__rootModule___commonjs-entry-6275a3de.js', './index-e19d3678.js'], (function (exports) {
  var __contextModule__ = typeof module !== 'undefined' ? module : arguments[1];
;
  var wrap, remove$1, _typeof, print, isObject, inspect, truncate, withoutAll, Path, last, pushAt, _createForOfIteratorHelper, _toConsumableArray, _slicedToArray, chain, deepCopy, compact, _asyncToGenerator, arr, deferred, Closure, _createClass, _classCallCheck, uniq, emit, _inherits, _createSuper, isString, dissoc, _get, _getPrototypeOf, _defineProperty, runtime, joinPath, deepMerge, resource, values, select, pluck$1, pushIfNotIncluded, takeWhile, partition, merge, hull, invert, initializeClass, subscribe, regExpEscape, allOwnPropertiesOrFunctions, hashCode, adoptObject, registerExtension, ESMResource, Resource, exports$1, uniqBy, unsubscribe, keys, ReplaceVisitor, stringify, objectLiteral, member, parse, sqncExpr, nodes, ReplaceManyVisitor, varDecl, exprStmt, funcCall, funcExpr, forIn, block, ifStmt, binaryExpr, id, literal, assign, query, transform, parseFunction, QueryReplaceManyVisitor, topLevelDeclsAndRefs, queryNodes, logical, transformSingleExpression, objectSpreadTransform, wrapInStartEndCall, resolveReferences, scopes, Visitor, fuzzyParse, findGlobalVarRefs, knownGlobals, imports, refWithDeclAt, nodesAtIndex, isValidIdentifier;
  return {
    setters: [function (module) {
      ...
      last = module.q;
      pushAt = module.by;
      _createForOfIteratorHelper = module.J;
      ...
      dissoc = module.y;
      _get = module.br;
      _getPrototypeOf = module.bs;
      _defineProperty = module.$;
      runtime = module.bS;
      joinPath = module.aT;
      deepMerge = module.bT;
      resource = module.S;
      ...
      subscribe = module.aV;
      regExpEscape = module.bW;
      allOwnPropertiesOrFunctions = module.bX;
      hashCode = module.bY;
      adoptObject = module.aW;
      registerExtension = module.a0;
      ESMResource = module.bZ;
      Resource = module.b_;
      exports$1 = module.b$;
      uniqBy = module.X;
      unsubscribe = module.aQ;
      keys = module.bF;
    }, function (module) {
      ...
      topLevelDeclsAndRefs = module.u;
      queryNodes = module.w;
      logical = module.x;
      transformSingleExpression = module.y;
      objectSpreadTransform = module.z;
      wrapInStartEndCall = module.A;
      resolveReferences = module.B;
      scopes = module.C;
      Visitor = module.V;
      fuzzyParse = module.D;
      findGlobalVarRefs = module.E;
      knownGlobals = module.F;
      imports = module.G;
      refWithDeclAt = module.H;
      nodesAtIndex = module.I;
      isValidIdentifier = module.J;
    }],
    execute: (function () {
      ...
      var rewriteToCaptureTopLevelVariables = exports('y', __varRecorder__$q["lively.source-transform/capturing.js__define__"]("rewriteToCaptureTopLevelVariables", "function", function (parsed, assignToObj, options) {
        ...
        options.recordDefRanges ? __varRecorder__$q.computeDefRanges(rewritten, options) : null;
      ...
      var clearEmptyExports = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("clearEmptyExports", "function", function (parsed, options) {
        var topLevel = __varRecorder__$q.topLevelDeclsAndRefs(parsed);
      ...
      var replaceRefs = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("replaceRefs", "function", function (parsed, options) {
        ...
        var replaced = ReplaceVisitor.run(parsed, function (node, path) {
        ...
        return ReplaceVisitor.run(replaced, function (node, path, parent) {
      ...
      var additionalIgnoredDecls = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("additionalIgnoredDecls", "function", function (parsed, options) {
        var topLevel = __varRecorder__$q.topLevelDeclsAndRefs(parsed);
      ...
      var splitExportDeclarations = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("splitExportDeclarations", "function", function (parsed, options) {
      ...
      var fixDefaultAsyncFunctionExportForRegeneratorBug = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("fixDefaultAsyncFunctionExportForRegeneratorBug", "function", function (parsed, options) {
        var body = [];
      ...
      var computeDefRanges = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("computeDefRanges", "function", function (parsed, options) {
        var topLevel = __varRecorder__$q.topLevelDeclsAndRefs(parsed);

        return chain(topLevel.scope.varDecls).pluck("declarations").flat().value().concat(topLevel.scope.funcDecls.filter(function (ea) {
          return ea.id;
      ...
      __varRecorder__$q.computeDefRanges = computeDefRanges;
      ...
      var transformArrayPattern = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("transformArrayPattern", "function", function (pattern, transformState) {
        ...
        for (var i = 0; i < pattern.elements.length; i++) {
          ...
          if (el.type === "Identifier") {
            ...
            var decl = __varRecorder__$q.varDecl(el.argument, {
              type: "CallExpression",
              arguments: [{
                type: "Literal",
                value: i
            ...
            var decl = __varRecorder__$q.varDecl(el.left, __varRecorder__$q.conditional(__varRecorder__$q.binaryExpr(__varRecorder__$q.member(transformState.parent, __varRecorder__$q.id(i), true), "===", __varRecorder__$q.id("undefined")), el.right, __varRecorder__$q.member(transformState.parent, __varRecorder__$q.id(i), true)));
      ...
      var transformObjectPattern = __varRecorder__$q["lively.source-transform/capturing.js__define__"]("transformObjectPattern", "function", function (pattern, transformState) {
        ...
        for (var i = 0; i < pattern.properties.length; i++) {
          ...
          if (prop.type == "RestElement") {
            ...
            var decl = __varRecorder__$q.varDecl(prop.value, __varRecorder__$q.member(transformState.parent, prop.key));
            ...
            var decl = __varRecorder__$q.varDecl(prop.value.left, __varRecorder__$q.conditional(__varRecorder__$q.binaryExpr(__varRecorder__$q.member(transformState.parent, prop.key), "===", __varRecorder__$q.id("undefined")), prop.value.right, __varRecorder__$q.member(transformState.parent, prop.key)));
      ...
      __varRecorder__$q.block = destructured_1$4.block;
      ...
      var destructured_3 = transform;
      __varRecorder__$q.transformSingleExpression = destructured_3.transformSingleExpression;
      __varRecorder__$q.wrapInStartEndCall = destructured_3.wrapInStartEndCall;
      __varRecorder__$q.rewriteToCaptureTopLevelVariables = rewriteToCaptureTopLevelVariables;
      __varRecorder__$q.rewriteToRegisterModuleToCaptureSetters = rewriteToRegisterModuleToCaptureSetters;
      __varRecorder__$q.insertCapturesForExportedImports = insertCapturesForExportedImports;
      __varRecorder__$q.insertCapturesForFunctionDeclarations = insertCapturesForFunctionDeclarations;
                    ...
                    case 2:
                      ...
                      try {
                        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                          ...
                          alias = spec.local;
                          __varRecorder__$9.__inter0__ = ImportInjector.run(this.System, this.id, this["package"](), source, importData, alias), source = __varRecorder__$9.__inter0__.newSource;
                        }
                      } catch (err) {
                        _iterator2.e(err);
                      } finally {
              ...
              switch (_context.prev = _context.next) {
                ...
                case 50:
                  ...
                  if (isEsm) {
                    ...
                    load.metadata.format = "esm";
                    __varRecorder__$7.__inter0__ = __varRecorder__$7.prepareCodeForCustomCompile(System, source, load.name, mod, debug), __varRecorder__$7.__inter0__.options, source = __varRecorder__$7.__inter0__.source;
                    load.source = source;
                    ...
                    __varRecorder__$7.__inter1__ = __varRecorder__$7.prepareCodeForCustomCompile(System, source, load.name, mod, debug), __varRecorder__$7.__inter1__.options, source = __varRecorder__$7.__inter1__.source;
                    load.source = source;
                    load.metadata["lively.modules instrumented"] = true;
                    instrumented = true;
      ...
      var checkExistence = __varRecorder__$5["lively.modules/src/system.js__define__"]("checkExistence", "function", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url, System) {
          var cache;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
      ...
      var normalizeHook = __varRecorder__$5["lively.modules/src/system.js__define__"]("normalizeHook", "function", /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(proceed, name, parent, parentAddress) {
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 37:
                  if (!(!stage3.includes("jspm.dev") && stage3 !== "@empty")) {
                    _context4.next = 46;
                    break;
                  }
      ...
      var whenSystemModuleLoaded = __varRecorder__$5["lively.modules/src/system.js__define__"]("whenSystemModuleLoaded", "function", /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(moduleName) {
          return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
        ...
        _createClass(ExportLookup, [{
          ...
          value: function () {
            var _rawExportsOfModule = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(moduleId) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 36:
                      ...
                      result.exports = [];
                      _iterator = _createForOfIteratorHelper(mod._frozenModule ? moduleRecord.__module_exports__ : keys(moduleRecord));
                      _context4.prev = 39;
              ...
              }, _callee4, this, [[19, 58], [39, 50, 53, 56]]);
            }));
      ...
      __varRecorder__.System = defaultSystem;
