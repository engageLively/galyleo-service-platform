...
;
  ...
  return {
    setters: [function (module) {
      ...
      delay = module.l;
      _objectDestructuringEmpty = module.gj;
      _toConsumableArray = module.r;
      _inherits = module.d;
      _createSuper = module.e;
      resource = module.S;
      equals = module.Y;
      makeEmitter = module.gh;
      _assertThisInitialized = module.gk;
      backoff = module.gl;
      dissoc = module.y;
    }],
    execute: (function () {
      ...
      if (__varRecorder__.isNode) {
        __varRecorder__.require = System._nodeRequire("module")._load;
        __varRecorder__.ioClient = __varRecorder__.require("socket.io-client");
      } else {
