...
;
  ...
  return {
    setters: [function (module) {
      ...
      ObjectPool = module.gw;
      ClassHelper = module.gx;
      sortBy = module.ax;
      _toConsumableArray = module.r;
      humanReadableByteSize = module.aM;
      truncate = module.a1;
      printTable = module.e1;
      format = module.fq;
      _slicedToArray = module.o;
      findPathFromToId = module.gy;
      referenceGraph = module.gz;
      invert = module.ae;
      lookupPath = module.gA;
      modifyProperty = module.gB;
      _createForOfIteratorHelper = module.J;
      removeUnreachableObjects = module.eh;
      indent = module.dU;
    }],
    execute: (function () {
