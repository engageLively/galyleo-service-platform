System.register(['./__rootModule___commonjs-entry-2a340242.js', './canvas-eb622915.js'], (function (exports) {
  'use strict';
  var connect, fun, promise, pt, Color, addClassMappings, initializeClass, _createForOfIteratorHelper, Canvas;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/map.js");
      ...
      var TextMap = exports('default', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/map.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function TextMap_attachTo_(textMorph) {
            ...
            __varRecorder__.connect(textMorph, "viewChange", this, "updateDebounced");

            __varRecorder__.connect(textMorph, "textChange", this, "updateDebounced");

            __varRecorder__.connect(textMorph, "selectionChange", this, "updateDebounced");
          ...
          value: function TextMap_updateDebounced_() {
            ...
            if (this.owner === this.textMorph) {
              if ($world.get("search widget")) {
                ...
                this.position = __varRecorder__.pt(this.textMorph.width - this.width - 20, this.textMorph.padding.top() + 60 + this.textMorph.scroll.y);
              } else {
                this.height = this.textMorph.height - this.textMorph.padding.top() - 20;
                this.position = __varRecorder__.pt(this.textMorph.width - this.width - 20, this.textMorph.padding.top() + 5 + this.textMorph.scroll.y);
              }
            }

            __varRecorder__.fun.throttleNamed("update-" + this.id, 100, function () {
          ...
          value: function TextMap_update_() {
            var ctx = this.context,
                textMorph = this.textMorph,
                _this$measure = this.measure,
                width = _this$measure.width,
                height = _this$measure.height,
                heightPerLine = _this$measure.heightPerLine,
                widthPerChar = _this$measure.widthPerChar;
            ...
            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                ...
                if (typeof color === "string") {
                  var col = __varRecorder__.Color.fromString(color);
          ...
          value: function TextMap_onMouseDown_(evt) {
            ...
            __varRecorder__.promise.delay(100).then(function () {
          ...
          get: function get() {
            return {
              ...
              extent: {
                defaultValue: __varRecorder__.pt(60, 50)
              },
              markers: {},
              draggable: {
                defaultValue: true
