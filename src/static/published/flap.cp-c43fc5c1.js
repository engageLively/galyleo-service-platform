System.register(['./__rootModule___commonjs-entry-2a340242.js'], (function (exports) {
  'use strict';
  var Color, pt, TilingLayout, component, ViewModel, rect, initializeClass, _asyncToGenerator;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/studio/flap.cp.js");
      ...
      var FlapModel = exports('FlapModel', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/studio/flap.cp.js");
      ...
      __varRecorder__.FlapModel = FlapModel;
      __varRecorder__.Flap = __varRecorder__.component["for"](function () {
        return __varRecorder__.component({
          ...
          extent: __varRecorder__.pt(30, 120),
