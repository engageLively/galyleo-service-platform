System.register(['./__rootModule___commonjs-entry-2a340242.js'], (function (exports) {
  'use strict';
  var fun, obj, arr, num, string, graph, Path, ObjectPool, lookupPath, referencesAndClassNamesOfId, modifyProperty, removeUnreachableObjects, referenceGraph, findPathFromToId, ClassHelper, initializeClass, _toConsumableArray, _slicedToArray, _createForOfIteratorHelper;
  return {
    setters: [function (module) {
      ...
      graph = module.aa;
      Path = module.aR;
      ObjectPool = module.fT;
      lookupPath = module.fU;
      referencesAndClassNamesOfId = module.fV;
      modifyProperty = module.fW;
      removeUnreachableObjects = module.eY;
      referenceGraph = module.fX;
      findPathFromToId = module.fY;
      ClassHelper = module.fZ;
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.serializer2/debugging.js");
      ...
      __varRecorder__.graph = graph;
      __varRecorder__.Path = Path;
      __varRecorder__.ObjectPool = ObjectPool;
      __varRecorder__.lookupPath = lookupPath;
      __varRecorder__.referencesAndClassNamesOfId = referencesAndClassNamesOfId;
      __varRecorder__.modifyProperty = modifyProperty;
      __varRecorder__.removeUnreachableObjects = removeUnreachableObjects;
      __varRecorder__.referenceGraph = referenceGraph;
      __varRecorder__.findPathFromToId = findPathFromToId;
      __varRecorder__.ClassHelper = ClassHelper;
      var SnapshotInspector = exports('SnapshotInspector', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.serializer2/debugging.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function SnapshotInspector_processSnapshot_() {
            ...
            var pool = __varRecorder__.ObjectPool.fromSnapshot(snapshot);
          ...
          value: function SnapshotInspector_processPool_(pool) {
            ...
            pool.objectRefs().forEach(function (ref) {
              ...
              var _ref = snap[__varRecorder__.ClassHelper.classMetaForSerializationProp] || {},
          ...
          value: function SnapshotInspector_explainId_(id) {
            ...
            var _ref2 = ref[__varRecorder__.ClassHelper.classMetaForSerializationProp] || {
              className: "Object"
            },
          ...
          value: function SnapshotInspector_sorted_(prop) {
            ...
            return __varRecorder__.arr.sortBy(Object.keys(this[prop]).map(function (key) {
          ...
          value: function SnapshotInspector_report_(prop) {
            var items = [["#bytes", "#objs", "avg", prop]].concat(_toConsumableArray(this.sorted(prop).map(function (tuple) {
              return [__varRecorder__.num.humanReadableByteSize(tuple.bytes), tuple.count, __varRecorder__.num.humanReadableByteSize(tuple.bytes / tuple.count), __varRecorder__.string.truncate(tuple.name, 300)];
            })));
            return __varRecorder__.string.printTable(items, {
              separator: " | "
            });
          }
        }, {
          ...
          value: function SnapshotInspector_toString_() {
            ...
            return __varRecorder__.string.format("Total: %s (%s objs - %s per obj)", __varRecorder__.num.humanReadableByteSize(bytesAltogether), objCount, __varRecorder__.num.humanReadableByteSize(bytesAltogether / objCount)) + "\nclasses:\n" + this.report("classes") + "\nexpressions:\n" + this.report("expressions");
          }
        }, {
          key: "biggestObjectsOfType",
          value: function SnapshotInspector_biggestObjectsOfType_(typeString) {
            return __varRecorder__.arr.sortBy(this.classes[typeString].objects.map(function (_ref3) {
          ...
          value: function SnapshotInspector_toCSV_() {
            ...
            this.sorted("classes").forEach(function (tuple) {
              lines.push([tuple.name, __varRecorder__.num.humanReadableByteSize(tuple.bytes), tuple.bytes, tuple.count, __varRecorder__.num.humanReadableByteSize(tuple.bytes / tuple.count), tuple.bytes / tuple.count].join(","));
            });
            return lines.join("\n");
          }
        }, {
          ...
          value: function SnapshotInspector_findPathFromToId_(fromId, toId) {
            ...
            var s = this.snapshot;
            if (s.snapshot) s = s.snapshot;
            return __varRecorder__.findPathFromToId(s, fromId, toId, options);
          }
        }, {
          key: "referenceGraph",
          value: function SnapshotInspector_referenceGraph_() {
            var s = this.snapshot;
            if (s.snapshot) s = s.snapshot;
            return __varRecorder__.referenceGraph(s);
          }
        }, {
          key: "referenceCounts",
          value: function SnapshotInspector_referenceCounts_() {
            var invertedG = __varRecorder__.graph.invert(this.referenceGraph());
          ...
          value: function SnapshotInspector_lookupPath_(fromId, path) {
            var s = this.snapshot;
            if (s.snapshot) s = s.snapshot;
            return __varRecorder__.lookupPath(s, fromId, path);
          }
        }, {
          key: "idsReferencingId",
          value: function SnapshotInspector_idsReferencingId_(id) {
            return __varRecorder__.graph.invert(this.referenceGraph())[id];
          }
        }, {
          key: "modifyProperty",
          value: function SnapshotInspector_modifyProperty_(objId, pathToProperty, modifyFn) {
            var snapshot = this.snapshot;
            if (snapshot.snapshot) snapshot = snapshot.snapshot;
            return __varRecorder__.modifyProperty(snapshot, objId, pathToProperty, modifyFn);
          }
        }, {
          key: "replaceReferencesTo",
          value: function SnapshotInspector_replaceReferencesTo_(id, replaceFn) {
            var refs = __varRecorder__.graph.invert(this.referenceGraph())[id];
          ...
          value: function SnapshotInspector_removeUnreachableObjects_(rootId) {
            ...
            if (snapshot.snapshot) snapshot = snapshot.snapshot;
            return __varRecorder__.removeUnreachableObjects([rootId], snapshot);
          }
        }, {
          ...
          value: function SnapshotInspector_reportAboutObject_(id, refs, invertedRefs) {
            ...
            invertedRefs = invertedRefs || __varRecorder__.graph.invert(refs);
            ...
            return "".concat(id, "\n") + " is a ".concat(this.explainId(id), " object\n") + " path from root: ".concat(this.findPathFromToId(this.snapshot.id, id), "\n") + " references \n".concat(__varRecorder__.string.indent(__varRecorder__.string.printTable(refsFrom), "  ", 2), "\n") + " referenced by:\n".concat(__varRecorder__.string.indent(__varRecorder__.string.printTable(refsTo), "  ", 2), "\n");
          }
        }, {
          ...
          value: function SnapshotInspector_reportAboutObjects_(ids) {
            ...
            var invertedRefs = __varRecorder__.graph.invert(refs);
