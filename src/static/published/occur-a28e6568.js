System.register(['./__rootModule___commonjs-entry-2a340242.js', './search-1fb0a4bc.js'], (function (exports) {
  'use strict';
  var arr, obj, KeyHandler, initializeClass, TextSearcher;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/occur.js");
      ...
      __varRecorder__.KeyHandler = KeyHandler;
      __varRecorder__.occurKeyHandler = Object.assign(__varRecorder__.KeyHandler.withBindings([{
        keys: "Escape|Ctrl-G",
        command: "occur exit"
      }, {
        keys: "Enter",
      ...
      var occurStartCommand = exports('occurStartCommand', {
        name: "occur",
      ...
      var Occur = exports('Occur', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/occur.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function Occur___serialize___() {
            return {
              __expr__: "new Occur(".concat(__varRecorder__.obj.inspect(__varRecorder__.obj.dissoc(this.options, ["textMorph"])), ")"),
              bindings: {
          ...
          value: function Occur_matchingLines_() {
            ...
            var search = new __varRecorder__.TextSearcher(this.textMorph);
            ...
            return __varRecorder__.arr.groupBy(found, function (_ref) {
