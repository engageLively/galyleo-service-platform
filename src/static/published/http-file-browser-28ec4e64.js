System.register(['./__rootModule___commonjs-entry-2a340242.js', './index-57981d2f.js', './text-editor-c46e6e07.js', './inputs-b8bdf948.js', './loading-indicator.cp-680c2ecd.js', './ui.cp-46daffed.js', './editor-modes-146d3c1c.js', './search-1fb0a4bc.js', './messages.cp-ccfb5763.js'], (function (exports) {
  'use strict';
  var Morph, Image, Label, arr, promise, num, date, string, pt, Rectangle, Color, connect, resource, _asyncToGenerator, initializeClass, _slicedToArray, Tree, TreeData, TextEditor, InputLine;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/http-file-browser.js");
      __varRecorder__.Morph = Morph;
      __varRecorder__.Image = Image;
      __varRecorder__.Label = Label;
      __varRecorder__.Tree = Tree;
      __varRecorder__.TreeData = TreeData;
      __varRecorder__.arr = arr;
      __varRecorder__.promise = promise;
      __varRecorder__.num = num;
      __varRecorder__.date = date;
      ...
      __varRecorder__.TextEditor = TextEditor;
      ...
      __varRecorder__.browserCommands = [{
        ...
        exec: function exec(browser) {
          ...
          if (!sel) {
            ...
            var image = new __varRecorder__.Image({
              name: sel.url,
              imageUrl: sel.url
            });
            image.openInWorld();
          } else {
            var editor = __varRecorder__.TextEditor.openURL(sel.url, {
              extent: __varRecorder__.pt(600, 800)
            });
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    fnText.fontColor = __varRecorder__.Color.rgb(52, 152, 219);
                    _context4.next = 8;
                    return fnText.animate({
                      customTween: function customTween(p) {
                        return fnText.fontColor = __varRecorder__.Color.rgb(52, 152, 219).interpolate(p, __varRecorder__.Color.black);
                      }
                    });
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 9:
                    res = __varRecorder__.resource(newDir);
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 9:
                    res = __varRecorder__.resource(newFile);
            ...
            return regeneratorRuntime.wrap(function _callee11$(_context11) {
              while (1) {
                switch (_context11.prev = _context11.next) {
                  ...
                  case 6:
                    res = browser.selectedFile;
                    newRes = __varRecorder__.resource(newName);
      ...
      var HTTPFileBrowserNode = exports('HTTPFileBrowserNode', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/http-file-browser.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function HTTPFileBrowserNode_display_(_ref8) {
            ...
            var lastModified = resource.lastModified,
                size = resource.size;
            var datePrinted = lastModified ? __varRecorder__.date.format(lastModified, "yyyy-mm-dd HH:MM:ss") : " ".repeat(col1Size);
            var sizePrinted = size ? __varRecorder__.num.humanReadableByteSize(size) : "";
          ...
          value: function () {
            var _HTTPFileBrowserNode_collapse_ = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(node, bool) {
              var exclude, _varRecorder__$arr$p, _varRecorder__$arr$p2, dirs, files;
                ...
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    ...
                    case 2:
                      ...
                      _context13.t0 = __varRecorder__.arr;
                      _context13.next = 8;
                    ...
                    case 8:
                      ...
                      _varRecorder__$arr$p = _context13.t0.partition.call(_context13.t0, _context13.t1, _context13.t2);
                      _varRecorder__$arr$p2 = _slicedToArray(_varRecorder__$arr$p, 2);
                      dirs = _varRecorder__$arr$p2[0];
                      files = _varRecorder__$arr$p2[1];
                      dirs = __varRecorder__.arr.sortBy(dirs, function (ea) {
                        return ea.name().toLowerCase();
                      });
                      files = __varRecorder__.arr.sortBy(files, function (ea) {
                        return ea.name().toLowerCase();
                      });
      ...
      var HTTPFileBrowser = exports('default', function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function HTTPFileBrowser_relayout_() {
            ...
            var buttonHeight = 20;
            locationInput.position = __varRecorder__.pt(0, 0);
            locationInput.extent = __varRecorder__.pt(this.width - 3 * buttonHeight, locationInputHeight);
            topButtons.forEach(function (btn) {
              return btn.extent = __varRecorder__.pt(buttonHeight, buttonHeight);
            });
            ...
            fileTree.extent = __varRecorder__.pt(this.width, this.height - locationInputHeight - selectedFileNameHeight - buttonHeight);
            selectedFileName.topLeft = fileTree.bottomLeft;
            selectedFileName.extent = __varRecorder__.pt(this.width, selectedFileNameHeight);
            bottomButtons.forEach(function (btn) {
              return btn.extent = __varRecorder__.pt(_this2.width / nButtons, buttonHeight);
            });
          ...
          value: function HTTPFileBrowser_whenFinishedLoading_() {
            ...
            return __varRecorder__.promise.waitFor(3000, function () {
          ...
          value: function HTTPFileBrowser_openLocation_(urlOrResource) {
            var res = typeof urlOrResource === "string" ? __varRecorder__.resource(urlOrResource) : urlOrResource;
              ...
              return regeneratorRuntime.wrap(function _callee15$(_context15) {
                while (1) {
                  switch (_context15.prev = _context15.next) {
                    ...
                    case 2:
                      target = typeof urlOrResource === "string" ? __varRecorder__.resource(urlOrResource) : urlOrResource;
              ...
              return regeneratorRuntime.wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    ...
                    case 5:
                      loc = __varRecorder__.resource(url);
          ...
          value: function HTTPFileBrowser_forFile_(urlOrResource, location) {
            ...
            try {
              res = __varRecorder__.resource(urlOrResource);
            } catch (e) {
              res = __varRecorder__.resource(__varRecorder__.string.joinPath(location || "", urlOrResource));
            }
          ...
          get: function get() {
            return {
              ...
              extent: {
                defaultValue: __varRecorder__.pt(500, 500)
              },
              excludeFiles: {
              ...
              submorphs: {
                initialize: function initialize() {
                  var btnStyle = {
                    type: "button",
                    borderRadius: 5,
                    padding: __varRecorder__.Rectangle.inset(0),
                    fontSize: 12,
                    grabbable: false,
                    draggable: false
                  };
                  this.submorphs = [new __varRecorder__.Tree({
                    name: "fileTree",
                    ...
                    padding: __varRecorder__.Rectangle.inset(4)
                  }), new __varRecorder__.InputLine({
                    name: "locationInput",
                    textString: "",
                    historyId: "http-file-browser-location-input-history",
                    padding: __varRecorder__.Rectangle.inset(4, 2)
                  }), {
                    type: "label",
                    name: "selectedFileName",
                    padding: __varRecorder__.Rectangle.inset(2, 2),
                    fontSize: 14,
                    ...
                    label: __varRecorder__.Label.icon("search"),
                    tooltip: "search for files"
                  }), Object.assign({
                    name: "reloadButton"
                  }, btnStyle, {
                    label: __varRecorder__.Label.icon("redo"),
                    tooltip: "reload list"
                  }), Object.assign({
                    name: "filterButton"
                  }, btnStyle, {
                    label: __varRecorder__.Label.icon("filter"),
                    tooltip: "set file filter"
                  }), Object.assign({
                    name: "openFileButton"
                  }, btnStyle, {
                    label: __varRecorder__.Label.icon("edit", {
                    ...
                    label: __varRecorder__.Label.icon("folder", {
                      textStyleClasses: ["far"]
                    }),
                    ...
                    label: __varRecorder__.Label.icon("file", {
                      textStyleClasses: ["far"]
                    }),
                    tooltip: "add file"
                  }), Object.assign({
                    ...
                    label: __varRecorder__.Label.icon("clone", {
                      textStyleClasses: ["far"]
                    }),
                    ...
                    label: __varRecorder__.Label.icon("trash-alt", {
                      textStyleClasses: ["far"]
                    }),
                  ...
                  __varRecorder__.connect(this, "extent", this, "relayout");

                  __varRecorder__.connect(locationInput, "inputAccepted", this, "onLocationChanged");

                  __varRecorder__.connect(fileTree, "selectedNode", this, "showSelectedFile");

                  __varRecorder__.connect(fileTree, "contextMenuRequested", this, "showMenuFor");

                  __varRecorder__.connect(searchButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "find file and select";
                    }
                  });

                  __varRecorder__.connect(reloadButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "refresh contents";
                    }
                  });

                  __varRecorder__.connect(filterButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "set file filter";
                    }
                  });

                  __varRecorder__.connect(openFileButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "open selected file";
                    }
                  });

                  __varRecorder__.connect(renameFileButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "rename file";
                    }
                  });

                  __varRecorder__.connect(deleteFileButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "delete file or directory";
                    }
                  });

                  __varRecorder__.connect(addFileButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "add file";
                    }
                  });

                  __varRecorder__.connect(addDirectoryButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "add directory";
                    }
                  });

                  __varRecorder__.connect(selectedFileName, "onMouseDown", this, "execCommand", {
                    converter: function converter() {
                      return "copy file path to clipboard";
                    }
                  });

                  __varRecorder__.connect(this, "onMouseMove", this, "hideBaseURL");

                  __varRecorder__.connect(this.ui.fileTree, "onDoubleMouseDown", this, "execCommand", {
                    converter: function converter() {
                      return "open selected file";
                    }
                  });
              ...
              location: {
                ...
                after: ["submorphs"],
                get: function get() {
                  return __varRecorder__.resource(this.ui.locationInput.input);
                },
