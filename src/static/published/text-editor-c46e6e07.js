System.register(['./__rootModule___commonjs-entry-2a340242.js', './ui.cp-46daffed.js', './messages.cp-ccfb5763.js', './index-57981d2f.js', './loading-indicator.cp-680c2ecd.js', './inputs-b8bdf948.js', './editor-modes-146d3c1c.js', './search-1fb0a4bc.js'], (function (exports) {
  'use strict';
  var Morph, Icon, TilingLayout, part, config, num, promise, pt, Rectangle, Color, connect, signal, once, resource, initializeClass, _toConsumableArray, _slicedToArray, _asyncToGenerator, _typeof, guessTextModeName, StatusMessageConfirm, StatusMessageWarning, InputLineDefault, SystemButton;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/text-editor.js");
      ...
      __varRecorder__.guessTextModeName = guessTextModeName;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    if (result.saved) {
                      textEditor.setStatusMessage(result.message || "saved", __varRecorder__.StatusMessageConfirm);

                      __varRecorder__.signal(textEditor, "contentSaved");
      ...
      var TextEditor = exports('default', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/text/text-editor.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function () {
            var _TextEditor_showFileContent_ = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(url) {
              var deferred, res, content, win;
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      deferred = __varRecorder__.promise.deferred();
                    ...
                    case 9:
                      res = __varRecorder__.resource(url);
                      _context5.next = 12;
                      return res.read();
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      ...
                      if (_typeof(content) === "object") __varRecorder__.__inter0__ = content, content = __varRecorder__.__inter0__.content, url = __varRecorder__.__inter0__.url;
                      ed = this.ui.contentText;

                      if (content.length > Math.pow(2, 19)) {
                        this.setStatusMessage("File content very big, ".concat(__varRecorder__.num.humanReadableByteSize(content.length), ". Styling is disabled"), __varRecorder__.StatusMessageWarning);
                      } else {
                        mode = __varRecorder__.guessTextModeName(content, url);
                      }
                    ...
                    case 15:
                      ...
                      ed.scroll = __varRecorder__.pt(0, 0);
          ...
          value: function TextEditor_onWindowClose_() {
            __varRecorder__.signal(this, "closed");
          }
        }, {
          key: "commands",
          get: function get() {
          ...
          value: function TextEditor_openAsEDITOR_(file, props) {
            ...
            return new Promise(function (resolve, reject) {
              __varRecorder__.once(editor, "contentSaved", resolve, "call", {
              ...
              __varRecorder__.once(editor, "closed", resolve, "call", {
                updater: function updater($upd) {
          ...
          get: function get() {
            return {
              ...
              fill: {
                defaultValue: __varRecorder__.Color.transparent
              },
              reactsToPointer: {
                defaultValue: false
              },
              border: {
                defaultValue: {
                  width: 0,
                  color: __varRecorder__.Color.black
                }
              },
              extent: {
                defaultValue: __varRecorder__.pt(700, 600)
              },
              historyId: {
              ...
              submorphs: {
                ...
                initialize: function initialize(existing) {
                  ...
                  var btnStyle = {
                    type: "button",
                    master: __varRecorder__.SystemButton
                  };
                  this.submorphs = [{
                    name: "h wrapper",
                    ...
                    layout: new __varRecorder__.TilingLayout({
                      ...
                      spacing: 10,
                      padding: __varRecorder__.Rectangle.inset(10, 10, 10, 10)
                    }),
                    submorphs: [Object.assign({
                      name: "loadButton",
                      label: [].concat(_toConsumableArray(__varRecorder__.Icon.textAttribute("rotate-right", {
                        lineHeight: 1.4
                      })), [" Reload", {
                        lineHeight: 1.4
                      }])
                      ...
                      name: "saveButton",
                      label: [].concat(_toConsumableArray(__varRecorder__.Icon.textAttribute("floppy-disk", {
                        lineHeight: 1.4
                      })), [" Save", {
                        lineHeight: 1.4
                      }])
                      ...
                      name: "removeButton",
                      label: [].concat(_toConsumableArray(__varRecorder__.Icon.textAttribute("trash", {
                        lineHeight: 1.4
                      })), [" Remove", {
                        lineHeight: 1.4
                      }])
                    ...
                    layout: new __varRecorder__.TilingLayout({
                      hugContentsVertically: true,
                      padding: __varRecorder__.Rectangle.inset(10, 0, 10, 10),
                      resizePolicies: [["urlInput", {
                        width: "fill",
                        height: "fixed"
                      }]]
                    }),
                    submorphs: [__varRecorder__.part(__varRecorder__.InputLineDefault, {
                      name: "urlInput",
                      historyId: this.historyId,
                      fontSize: 14,
                      height: 22
                    })]
                  }, Object.assign({}, __varRecorder__.config.codeEditor.defaultStyle, {
                    name: "contentText",
                    type: "text",
                  ...
                  __varRecorder__.connect(urlInput, "inputAccepted", this, "location");

                  __varRecorder__.connect(loadButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "load file";
                    }
                  });

                  __varRecorder__.connect(saveButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "save file";
                    }
                  });

                  __varRecorder__.connect(removeButton, "fire", this, "execCommand", {
                    converter: function converter() {
                      return "remove file";
                    }
                  });
              ...
              layout: {
                initialize: function initialize() {
                  this.layout = new __varRecorder__.TilingLayout({
                    axis: "column",
                    renderViaCSS: true,
              ...
              locationResource: {
                ...
                get: function get() {
                  ...
                  return __varRecorder__.resource(url);
                },
