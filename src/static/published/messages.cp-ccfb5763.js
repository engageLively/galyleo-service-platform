System.register(['./__rootModule___commonjs-entry-2a340242.js', './loading-indicator.cp-680c2ecd.js', './inputs-b8bdf948.js'], (function (exports) {
  'use strict';
  var ViewModel, Color, pt, string, easings, initializeClass, _asyncToGenerator, TilingLayout, Label, Icon, Text, ShadowObject, component, part, LinearGradient, rect, ButtonDefault;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__$1 = lively.FreezerRuntime.recorderFor("lively.halos/components/messages.js");
      ...
      var StatusMessage = function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.halos/components/messages.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function StatusMessage_alignAtBottomOf_(forMorph) {
            ...
            if (overlapY > 0) view.moveBy(__varRecorder__$1.pt(0, -overlapY));
          }
        }, {
          key: "close",
          ...
          value: function StatusMessage_updateMessage_() {
            ...
            if (!this.isMaximized) {
              text.modifyLines(0, Math.min(text.lineCount(), this.maxLines) - 1, function (l) {
                ...
                return __varRecorder__$1.string.truncate(l, maxLineLength, "...");
              });
            }
            ...
            var f = 10;
            this.title = __varRecorder__$1.string.truncate(text.textString || "", (this.view.width / f).toFixed(), "...");
            this.updateTitle();
          }
        }, {
          key: "onViewResize",
                  ...
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 8:
                      ...
                      this.view.withAnimationDo(function () {
                        ...
                        easing: __varRecorder__$1.easings.outExpo,
                        duration: 200
                      });
                      this.view.withAnimationDo(function () {
          ...
          value: function StatusMessage_fit_() {
            ...
            var minHeight = 55;
            var minWidth = 100;
            this.view.extent = __varRecorder__$1.pt(minWidth, minHeight).maxPt(text.textBounds().extent());
            this.relayout();
          }
        }, {
          key: "focus",
          ...
          get: function get() {
            return {
              ...
              color: {
                ...
                set: function set() {
                  var color = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : __varRecorder__$1.Color.rgba(209, 209, 209, 0.9);
                  this.view.fill = color;
                  if (!color) return;
                  var l = color.luma();
                  if (l > 0.5) this.fontColor = __varRecorder__$1.Color.rgb(66, 73, 73);else this.fontColor = __varRecorder__$1.Color.white;
                }
              },
              compactHeight: {
                readOnly: true,
              ...
              fontColor: {
                after: ["view"],
                defaultValue: __varRecorder__$1.Color.rgb(66, 73, 73)
              },
              expose: {
                readOnly: true,
                get: function get() {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.halos/components/messages.cp.js");
      ...
      __varRecorder__.LinearGradient = LinearGradient;
      __varRecorder__.rect = rect;
      __varRecorder__.pt = pt;
      __varRecorder__.StatusMessage = StatusMessage;
      __varRecorder__.MessageButton = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.ButtonDefault, {
          viewModel: {
            label: {
              value: __varRecorder__.Icon.textAttribute("times"),
              fontColor: __varRecorder__.Color.rgb(66, 73, 73),
              fontSize: 20,
              padding: __varRecorder__.rect(1, 1, 0, 0)
            }
          },
          name: "message button",
          borderColor: __varRecorder__.Color.rgb(149, 165, 166),
          borderRadius: 25,
          borderWidth: 0,
          extent: __varRecorder__.pt(25, 25),
          halosEnabled: false,
      ...
      }, __varRecorder__.MessageButton);
      __varRecorder__.MessageButtonHover = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.MessageButton, {
          name: "message button/hover",
          fill: __varRecorder__.Color.black.withA(0.1)
        });
      }, {
        module: "lively.halos/components/messages.cp.js",
      ...
      }, __varRecorder__.MessageButtonHover);
      __varRecorder__.MessageButtonClick = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.MessageButton, {
          name: "message button/click",
          fill: __varRecorder__.Color.black.withA(0.2)
        });
      }, {
        module: "lively.halos/components/messages.cp.js",
      ...
      }, __varRecorder__.MessageButtonClick);
      __varRecorder__.StatusMessageDefault = __varRecorder__.component["for"](function () {
        return __varRecorder__.component({
          name: "status message default",
          defaultViewModel: __varRecorder__.StatusMessage,
          ...
          dropShadow: new __varRecorder__.ShadowObject({
            distance: 8,
            rotation: 90,
            color: __varRecorder__.Color.rgba(0, 0, 0, 0.3),
            blur: 25
          }),
          extent: __varRecorder__.pt(669, 128),
          fill: __varRecorder__.Color.rgba(209, 209, 209, 0.9),
          ...
          submorphs: [{
            ...
            extent: __varRecorder__.pt(669, 40),
            ...
            layout: new __varRecorder__.TilingLayout({
              axisAlign: "center",
              orderByIndex: true,
              padding: __varRecorder__.rect(10, 5, -5, 0),
              renderViaCSS: false,
              reactToSubmorphAnimations: true,
            ...
            submorphs: [{
              ...
              name: "message icon",
              extent: __varRecorder__.pt(22, 23),
              fontColor: __varRecorder__.Color.rgb(66, 73, 73),
              fontSize: 20,
              padding: __varRecorder__.rect(1, 1, 0, 0),
              reactsToPointer: false,
              halosEnabled: false,
              textAndAttributes: __varRecorder__.Icon.textAttribute("info-circle")
            }, {
              type: "text",
              needsDocument: true,
              name: "message title",
              extent: __varRecorder__.pt(597, 37),
              fill: __varRecorder__.Color.rgba(0, 0, 0, 0),
              fixedWidth: true,
              fixedHeight: true,
              readOnly: true,
              ...
              padding: __varRecorder__.rect(8, 5, 0, 3),
              reactsToPointer: false,
              halosEnabled: false,
              ...
              name: "close button",
              position: __varRecorder__.pt(465.2, 0.2),
              width: 30,
            ...
            clipMode: "auto",
            extent: __varRecorder__.pt(669, 87.5),
            fill: __varRecorder__.Color.rgba(0, 0, 0, 0),
            fixedHeight: true,
            fixedWidth: true,
            fontColor: __varRecorder__.Color.rgb(66, 73, 73),
            ...
            fontSize: 15,
            lineWrapping: "by-words",
            padding: __varRecorder__.rect(10, 10, 0, 0),
            halosEnabled: false,
      ...
      }, __varRecorder__.StatusMessageDefault);
      __varRecorder__.StatusMessageConfirm = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.StatusMessageDefault, {
          extent: __varRecorder__.pt(669, 128),
          name: "status message confirm",
          fill: new __varRecorder__.LinearGradient({
            stops: [{
              offset: 0,
              color: __varRecorder__.Color.rgb(46, 204, 113)
            }, {
              offset: 1,
              color: __varRecorder__.Color.rgb(39, 174, 96)
            }],
            vector: __varRecorder__.rect(0, 0, 0, 1)
          }),
          submorphs: [{
            name: "horizontal float",
            submorphs: [{
      ...
      }, __varRecorder__.StatusMessageConfirm);
      __varRecorder__.StatusMessageError = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.StatusMessageDefault, {
          name: "status message error",
          fill: new __varRecorder__.LinearGradient({
            stops: [{
              offset: 0,
              color: __varRecorder__.Color.rgb(231, 76, 60)
            }, {
              offset: 1,
              color: __varRecorder__.Color.rgb(192, 57, 43)
            }],
            vector: __varRecorder__.rect(0, 0, 0, 1)
          }),
          submorphs: [{
            ...
            submorphs: [{
              ...
              fontColor: __varRecorder__.Color.rgb(255, 255, 255),
              fontSize: 20,
              textAndAttributes: __varRecorder__.Icon.textAttribute("times-circle")
            }, {
              name: "message title",
              fontColor: __varRecorder__.Color.white,
      ...
      }, __varRecorder__.StatusMessageError);
      __varRecorder__.StatusMessageWarning = __varRecorder__.component["for"](function () {
        return __varRecorder__.component(__varRecorder__.StatusMessageDefault, {
          name: "status message warning",
          borderColor: __varRecorder__.Color.rgbHex("DA9819"),
          fill: new __varRecorder__.LinearGradient({
            stops: [{
              offset: 0,
              color: __varRecorder__.Color.rgb(249, 213, 68)
            }, {
              offset: 1,
              color: __varRecorder__.Color.rgb(219, 162, 18)
            }],
            vector: __varRecorder__.rect(0.5, 1, 0, 1)
          })
        });
      }, {
        module: "lively.halos/components/messages.cp.js",
      ...
      }, __varRecorder__.StatusMessageWarning);
