System.register(['./__rootModule___commonjs-entry-2a340242.js', './loading-indicator.cp-680c2ecd.js', './index-57981d2f.js', './inputs-b8bdf948.js'], (function (exports) {
  'use strict';
  var morph, TilingLayout, Icon, easings, Morph, Color, Rectangle, rect, pt, noUpdate, arr, obj, fun, tree, getClassName, Layout, initializeClass, _createForOfIteratorHelper, _toConsumableArray, _asyncToGenerator, component, ViewModel, part, touchInputDevice, Label, connect, PropLabel, Tree, TreeData, SearchField;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__$1 = lively.FreezerRuntime.recorderFor("lively.ide/studio/interactive-tree.js");
      __varRecorder__$1.Tree = Tree;
      __varRecorder__$1.TreeData = TreeData;
      ...
      __varRecorder__$1.Layout = Layout;
      var InteractiveTreeContainer = function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/studio/interactive-tree.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function InteractiveTreeContainer_onGrab_(evt) {
            var tree = this.tree;
            var node = this.node;
            this.fill = __varRecorder__$1.Color.gray.withA(0.5);
          ...
          value: function InteractiveTreeContainer_onBeingDroppedOn_(hand, recipient) {
            ...
            var after = function after() {
              _this.fill = __varRecorder__$1.Color.gray.withA(0.5);
              _this.opacity = 1;
      ...
      var InteractiveTreeData = function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function InteractiveTreeData_add_(node) {
            ...
            if (before) {
              __varRecorder__$1.arr.pushAt(parent.children, node, parent.children.indexOf(before));
          ...
          value: function InteractiveTreeData_remove_(node) {
            ...
            __varRecorder__$1.arr.remove(parent.children, node);
      ...
      var InteractiveTree = function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function InteractiveTree_update_(force) {
            ...
            if (force) {
              this.embeddedMorphs.forEach(function (m) {
                if (m.isContainer) {
                  if (!__varRecorder__$1.obj.equals(m.fill, __varRecorder__$1.Color.transparent)) {
                    m.fill = __varRecorder__$1.Color.transparent;
                  }
                    ...
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        return _this4.animate({
                          ...
                          duration: 300,
                          easing: __varRecorder__$1.easings.linear
                        });
          ...
          value: function InteractiveTree_resetContainerSelection_() {
            this.embeddedMorphs.forEach(function (m) {
              if (m.isContainer) m.fill = __varRecorder__$1.Color.transparent;
            });
          }
        }, {
          ...
          value: function InteractiveTree_showDropPreviewFor_(target) {
            ...
            if (!hoveredContainer) {
              ...
              if (__varRecorder__$1.arr.last(this.treeData.root.children) === placeholder) return;
            ...
            if (hoveredContainer) {
              ...
              if (Math.abs(charBounds.top() - pos.y) < borderDist) {
                ...
                hoveredContainer.fill = __varRecorder__$1.Color.gray.withA(0.5);
          ...
          value: function InteractiveTree_ensurePlaceholder_() {
            var basicLineExtent = __varRecorder__$1.pt(this.width - 100, this.document.getLine(0).height);

            if (!this._previewNode) {
              this._previewNode = {
                container: __varRecorder__$1.morph({
                  acceptsDrops: false,
                  reactsToPointer: false,
                  fill: __varRecorder__$1.Color.gray.withA(0.5),
                  borderRadius: 5
                }),
                isCollapsed: true,
                isLeaf: true
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function SceneGraphTree_selectMorphInTarget_(morph) {
            ...
            this.treeData.followPath([morph].concat(_toConsumableArray(morph.ownerChain())).reverse(), function (m, node) {
              ...
              if (node) _this7.selectedNode = node;
            });
          }
        }, {
          key: "onLoad",
          ...
          value: function SceneGraphTree_isNodeOutOfSync_(node) {
            ...
            if (this.treeData.root === node) {
              return this.treeData.root.children.length !== this.target.submorphs.filter(function (m) {
                return !_this9.ignoreMorph(m);
              }).length;
            }
          ...
          value: function SceneGraphTree_getNewChildren_(node) {
            ...
            var _loop = function _loop(i) {
              ...
              var children = __varRecorder__$1.arr.without(node.children, _this10._previewNode);

              var existingChild = children.find(function (n) {
                return n.container && n.container.target.id === m.id;
              });
              if (existingChild) newChildren[i] = existingChild;else newChildren[i] = _this10.readMorphHierarchy(m);
            };
          ...
          value: function SceneGraphTree_refresh_() {
            ...
            __varRecorder__$1.tree.prewalk(root, function (node) {
              if (node === root && _this11.isNodeOutOfSync(node)) {
                node.children = _this11.getNewChildren(node);
              }

              if (node.container && _this11.isNodeOutOfSync(node)) {
                changes = true;
          ...
          value: function SceneGraphTree_ignoreMorph_(m) {
            ...
            return m.isContainer || m.isWindow || m.getWindow() || m.isEpiMorph || m.isHand || m.isHaloItem || m.isCommentIndicator || ["lively.halos"].includes(m.constructor[Symbol["for"]("lively-module-meta")]["package"].name) || ["Menu"].includes(m.constructor.name);
          }
        }, {
          key: "onDropHoverOut",
          ...
          value: function SceneGraphTree_onDropHoverIn_(evt) {
            ...
            if (morph && !morph.isContainer) {
              ...
              container.leftCenter = __varRecorder__$1.pt(-20, 0);
            }
          }
        }, {
          ...
          value: function SceneGraphTree_readMorphHierarchy_(morph) {
            ...
            return __varRecorder__$1.tree.mapTree(morph, function (m, children) {
              var res = {
                name: m.name,
                isCollapsed: true,
                getContainer: function getContainer() {
                  return _this12.renderContainerFor(m);
                },
                visible: true,
                children: children
              };
              ...
              return m.submorphs.filter(function (sub) {
                return m.isWorld ? !_this12.ignoreMorph(sub) : true;
              });
            });
          }
        }, {
          ...
          value: function SceneGraphTree_collapseAll_() {
            ...
            this.treeData.asList().forEach(function (node) {
              return node !== _this13.treeData.root ? node.isCollapsed = true : node.isCollapsed = false;
            });
          }
        }, {
          key: "filterMorphs",
                    ...
                    case 5:
                      if (!this.treeData.filterActive) {
                        this.treeData.asList().forEach(function (node) {
                          ...
                          node.visible = true;
                          node.isCollapsed = _this14._collapseState.has(node) ? _this14._collapseState.get(node) : true;
                        });
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/studio/scene-graph.cp.js");
      ...
      __varRecorder__.touchInputDevice = touchInputDevice;
      ...
      __varRecorder__.PropLabel = PropLabel;
      __varRecorder__.SceneGraphTree = SceneGraphTree;
      __varRecorder__.InteractiveTreeData = InteractiveTreeData;
      __varRecorder__.SearchField = SearchField;
      __varRecorder__.getClassName = getClassName;
      ...
      var MorphPanelModel = exports('MorphPanelModel', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/studio/scene-graph.cp.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function MorphPanelModel_attachToWorld_(world) {
            __varRecorder__.connect(world, "onChange", this, "onHierarchyChange", {
              garbageCollect: true
            });

            __varRecorder__.connect(world, "onSubmorphChange", this, "onHierarchyChange", {
              garbageCollect: true
            });

            __varRecorder__.connect(world, "showHaloFor", this, "selectNode", {
              garbageCollect: true
            });
          ...
          value: function MorphPanelModel_onHierarchyChange_(change) {
            ...
            if (change.selector === "addMorphAt" || change.selector === "removeMorph" || change.prop === "name") {
              ...
              __varRecorder__.fun.debounceNamed("scene-graph-update", 50, function () {
          ...
          value: function MorphPanelModel_onWorldResize_() {
            ...
            var offsetTop = navigator.standalone && __varRecorder__.touchInputDevice ? 25 : 0;
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      view.withAnimationDo(function () {
                        ...
                        duration: 300,
                        easing: __varRecorder__.easings.outCirc
                      });
      ...
      var NewSceneGraphTree = exports('NewSceneGraphTree', function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function NewSceneGraphTree_renderContainerFor_() {
            var submorph = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : __varRecorder__.morph({
              name: "root"
            });

            var container = __varRecorder__.part(__varRecorder__.MorphNode, {
              width: this.width,
              viewModel: {
                tree: this,
                target: submorph
          ...
          value: function NewSceneGraphTree_onMouseMove_(evt) {
            ...
            this.highlightLineAtCursor(evt, {
              background: __varRecorder__.Color.transparent,
      ...
      }(__varRecorder__.SceneGraphTree));
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function () {
            var _MorphNodeModel_refresh_ = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var target, _this$ui, morphIcon, layoutIndicator, nameLabel, visibilityIcon, icon, indicatorVisibility, indicatorRot;
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      _this$ui = this.ui, morphIcon = _this$ui.morphIcon, layoutIndicator = _this$ui.layoutIndicator, nameLabel = _this$ui.nameLabel, visibilityIcon = _this$ui.visibilityIcon;
                      ...
                      if (!__varRecorder__.obj.equals(icon, morphIcon.value)) {
          ...
          value: function MorphNodeModel_getIcon_(target) {
            ...
            return __varRecorder__.Icon.textAttribute(klassIconMapping[__varRecorder__.getClassName(target)] || "codepen", {
              paddingTop: "0px",
          ...
          value: function MorphNodeModel_highlightTerm_(term) {
            ...
            nameLabel.textAndAttributes = _toConsumableArray(__varRecorder__.arr.interpose(inBetween.map(function (x) {
              return [x, {}];
            }), [term, {
              fontWeight: "900"
            }]).flat());
                  ...
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 6:
                      ...
                      if (!tree.fullContainsWorldPoint(view.globalPosition)) {
                        this.onDragOutside();
                      } else view.leftCenter = __varRecorder__.pt(-20, 0);
          ...
          value: function MorphNodeModel_onDragOutside_() {
            ...
            if (!this.queue) {
              var tree = this.tree;
              this.queue = __varRecorder__.fun.createQueue("container-hover-queue", /*#__PURE__*/function () {
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          ...
                          self.remove();
                          self.target.position = __varRecorder__.pt(0, 0);
                          tree.treeData.remove(_this4.tree._previewNode);
                          tree.update(true);
                          _context4.next = 12;
          ...
          value: function MorphNodeModel_onChildAdded_(child) {
            ...
            this.target.withMetaDo({
              ...
              if (neighbor) {
                var actualIndex = _this5.target.submorphs.indexOf(neighbor.container.target);

                _this5.target.addMorphAt(child.target, actualIndex);

                child.target.globalPosition = posBackup;
              } else {
                _this5.target.addMorph(child.target);
          ...
          value: function MorphNodeModel_onBeingDroppedOn_($super, hand, recipient) {
            ...
            var after = function after() {
              view.fill = __varRecorder__.Color.gray.withA(0.5);
              view.opacity = 1;
              _this6.tree._dropInProgress = false;
            ...
            return {
              ...
              node: {
                ...
                get: function get() {
                  ...
                  var treeData = this.tree.treeData;
                  return treeData && treeData.asList().find(function (m) {
                    return m.container === _this7.view;
                  });
                }
              },
              dragTriggerDistance: {
      ...
      __varRecorder__.MorphNodeModel = MorphNodeModel;
      __varRecorder__.MorphNode = __varRecorder__.component["for"](function () {
        return __varRecorder__.component({
          ...
          draggable: true,
          grabbable: true,
          extent: __varRecorder__.pt(174.1, 30.8),
          submorphs: [{
            type: __varRecorder__.Label,
            name: "morph icon",
            opacity: 0.4,
            fontSize: 16,
            fill: __varRecorder__.Color.rgba(229, 231, 233, 0),
            fontColor: __varRecorder__.Color.rgb(208, 208, 208),
            fontFamily: "Material Icons",
            reactsToPointer: false,
            padding: __varRecorder__.Rectangle.inset(0, 0, 0, 5),
            textAndAttributes: ["\uE264", {
              fontSize: 16,
              fontFamily: "Material Icons"
            }]
          }, __varRecorder__.part(__varRecorder__.PropLabel, {
            name: "name label",
            lineHeight: 2.5,
            fixedWidth: true,
            fixedHeight: true,
            clipMode: "hidden",
            reactsToPointer: false,
            master: __varRecorder__.PropLabel,
            padding: __varRecorder__.rect(0),
      ...
      }, __varRecorder__.MorphNode);
      __varRecorder__.MorphPanel = __varRecorder__.component["for"](function () {
        return __varRecorder__.component({
          defaultViewModel: __varRecorder__.MorphPanelModel,
          name: "morph panel",
          nativeCursor: "ew-resize",
          extent: __varRecorder__.pt(250, 1000),
          draggable: true,
          layout: new __varRecorder__.TilingLayout({
            axis: "column",
            orderByIndex: true,
          ...
          submorphs: [{
            ...
            layout: new __varRecorder__.TilingLayout({
              axis: "column",
              orderByIndex: true,
              padding: __varRecorder__.rect(0, 60, 0, -60),
            ...
            fill: __varRecorder__.Color.rgb(30, 30, 30).withA(0.95),
            submorphs: [__varRecorder__.part(__varRecorder__.SearchField, {
              name: "search field",
              fontColor: __varRecorder__.Color.rgb(247, 247, 247),
              fontSize: 13,
              extent: __varRecorder__.pt(238, 24.9),
              borderWidth: 0,
              fill: __varRecorder__.Color.rgb(152, 152, 152),
              borderRadius: 0,
              submorphs: [{
                name: "placeholder",
                fontSize: 14
              ...
              treeData: new __varRecorder__.InteractiveTreeData({}),
              name: "scene graph",
              acceptsDrops: true,
              selectionColor: __varRecorder__.Color.rgbHex("B2EBF2").withA(0.25),
              fill: __varRecorder__.Color.rgba(255, 255, 255, 0),
              clipMode: "hidden",
              lineHeight: 2,
