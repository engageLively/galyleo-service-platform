System.register(['./__rootModule___commonjs-entry-2a340242.js'], (function (exports) {
  'use strict';
  var pt, Point, rect, Color, Morph, connect, initializeClass;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.components/canvas.js");
      __varRecorder__.pt = pt;
      __varRecorder__.Point = Point;
      ...
      var Canvas = exports('C', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.components/canvas.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function Canvas_initialize_() {
            ...
            __varRecorder__.connect(this, "extent", this, "onExtentChanged");
          ...
          value: function Canvas_nonTransparentArea_() {
            ...
            if (minX === width) return __varRecorder__.rect(0, 0, 0, 0);
            var maxX = minX;
            var maxY = minY;
            ...
            return {
              imageData: imageData,
              bounds: __varRecorder__.rect(minX, minY, maxX - minX + 1, maxY - minY + 1)
            };
          }
        }, {
          ...
          value: function Canvas_trimNonTransparent_() {
            ...
            if (!bounds.topLeft().equals(__varRecorder__.pt(0, 0))) {
          ...
          value: function Canvas_spiral_() {
            this.clear(__varRecorder__.Color.white);
            var start = this.innerBounds().center();
            var rotation = 0;
            var stepSize = 1;

            for (var i = 0; i < 150; i++) {
              var end = start.addPt(__varRecorder__.Point.polar(stepSize, rotation));
              this.line(start, end, {
                color: __varRecorder__.Color.random()
              });
              start = end;
              rotation += Math.PI / 10;
              stepSize += 0.3;
          ...
          get: function get() {
            return {
              extent: {
                defaultValue: __varRecorder__.pt(200, 200)
              },
              fill: {
              ...
              canvasExtent: {
                get: function get() {
                  return this._canvas && __varRecorder__.pt(this._canvas.width, this._canvas.height);
                }
              },
              canvasBounds: {
                readOnly: true,
