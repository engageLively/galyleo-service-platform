  ...
  return {
    ...
    execute: (function () {
      ...
      exports({
        ...
        findModeByExtension: findModeByExtension,
        findModeByFileName: findModeByFileName,
        findModeByMIME: findModeByMIME,
        findModeByName: findModeByName,
        getMode: getMode,
        ...
        visitDocumentTokens: visitDocumentTokens
      });

      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/editor-modes.js");
      ...
      function defineMode(name, setupFn) {
      ...
      function getMode(editorConfig, spec) {
      ...
      function registerHelper(method, mode, re) {}

      __varRecorder__.registerHelper = registerHelper;

      function indentLines(textMorph, mode, fromRow, toRow, how, aggressive, options) {
      ...
      function visitDocumentTokens(mode, document, fromRow, toRow, validBeforePos, newLineFn, recordFn) {
      ...
      function tokenizeDocument(mode, document, fromRow, toRow, validBeforePos) {
        var tokens = [];
        var current;
        var lines;
      ...
      function linesToTokenize(document, fromRow, toRow, validBeforePos) {
        ...
        if (toRow > startRow) {
          var lastLine = __varRecorder__.arr.last(lines);
      ...
      __varRecorder__.modes = modes;
      var passIndent = exports('passIndent', {});
      ...
      (function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/editor-modes.js");
      ...
      for (var i = 0; i < __varRecorder__.modeInfo.length; i++) {
        __varRecorder__.info = __varRecorder__.modeInfo[i];
        if (__varRecorder__.info.mimes) __varRecorder__.info.mime = __varRecorder__.info.mimes[0];
      }
