System.register(['./__rootModule___commonjs-entry-2a340242.js', './ui.cp-46daffed.js', './loading-indicator.cp-680c2ecd.js', './inputs-b8bdf948.js', './index-57981d2f.js', './editor-modes-146d3c1c.js', './search-1fb0a4bc.js'], (function (exports) {
  'use strict';
  var arr, string, initializeClass, _slicedToArray, _createForOfIteratorHelper, lessEqPosition, lessPosition, obj, fun, defaultDirectory, runCommand, _asyncToGenerator, pt, config, show, EditorPlugin;
  return {
    ...
    execute: (function () {
      ...
      var __varRecorder__$4 = lively.FreezerRuntime.recorderFor("lively.ide/diff/file-patch.js");
      __varRecorder__$4.arr = arr;
      __varRecorder__$4.string = string;
      var FilePatch = function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/diff/file-patch.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function FilePatch_read_(patchStringOrLines) {
            this.lines = Array.isArray(patchStringOrLines) ? patchStringOrLines : __varRecorder__$4.string.lines(patchStringOrLines);
            ...
            var headerLines = this.headerLines = __varRecorder__$4.arr.takeWhile(lines, function (line) {
            ...
            while (lines.length > 0) {
              var hunk = __varRecorder__$4.FilePatchHunk.read(lines, pathOriginal, pathChanged);
          ...
          value: function FilePatch_createPatchStringHeader_(reverse) {
            return __varRecorder__$4.arr.takeWhile(this.headerLines, function (line) {
              return !line.startsWith("---");
            }).join("\n");
          }
        }, {
          ...
          value: function FilePatch_changesByLines_() {
            return __varRecorder__$4.arr.invoke(this.hunks, "changesByLines").flat();
          }
        }, {
          key: "length",
          ...
          value: function FilePatch_patch_(s) {
            return this.changesByLines().reduce(function (patchedLines, change, i) {
              ...
              var noLinesRemoved = removed ? __varRecorder__$4.string.lines(removed).length : 0;
              var reallyRemoved = patchedLines.slice(startAddition, startAddition + noLinesRemoved).join("\n");

              if (removed !== reallyRemoved) {
                var msg = __varRecorder__$4.string.format("Change %s not matching: Expected \"%s\", got \"%s\"", i + 1, removed, reallyRemoved);
              ...
              var result = patchedLines.slice(0, startAddition).concat(added ? __varRecorder__$4.string.lines(added.replace(/\n$/, "")) : []).concat(patchedLines.slice(endAddition));
              return result;
            }, __varRecorder__$4.string.lines(s)).join("\n");
          }
        }, {
          key: "hunkForRow",
          ...
          value: function FilePatch_readAll_(patchString) {
            var patchLines = __varRecorder__$4.string.lines(patchString).reduce(function (patchLines, line) {
              var last = __varRecorder__$4.arr.last(patchLines);

              if (!last) patchLines.push([line]);else if (line.match(/^(---|\+\+\+|@@|-|\+|\\| )/)) last.push(line);else if (last.length === 1) {
                last.push(line);
      ...
      var FilePatchHunk = function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function FilePatchHunk_createPatchStringFromRows_(startRow, endRow, forReverseApply, includeOriginalChangedFile) {
            ...
            header = __varRecorder__$4.string.format("%s@@ -%s,%s +%s,%s @@", fileHeader, origLine, origLength, changedLine, changedLength);
          ...
          value: function FilePatchHunk_printHeader_(reverse, includeOriginalChangedFile) {
            ...
            return __varRecorder__$4.string.format("%s@@ -%s +%s @@", fileHeader, sub, add);
          }
        }, {
          key: "printLines",
      ...
      var __varRecorder__$3 = lively.FreezerRuntime.recorderFor("lively.ide/diff/tokenizer.js");
      __varRecorder__$3.FilePatch = FilePatch;

      var DiffTokenizer = function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/diff/tokenizer.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function DiffTokenizer_tokenize_(string) {
            var patches = __varRecorder__$3.FilePatch.readAll(string);
      ...
      var __varRecorder__$2 = lively.FreezerRuntime.recorderFor("lively.ide/diff/navigator.js");
      __varRecorder__$2.lessEqPosition = lessEqPosition;
      __varRecorder__$2.lessPosition = lessPosition;
      __varRecorder__$2.obj = obj;
      __varRecorder__$2.arr = arr;
      __varRecorder__$2.DiffTokenizer = DiffTokenizer;
      __varRecorder__$2.show = show;

      var DiffNavigator = function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/diff/navigator.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function DiffNavigator_ensureAST_(ed) {
            return new __varRecorder__$2.DiffTokenizer().tokenize(ed.textString).tokens;
          }
        }, {
          key: "tokenStateAt",
          value: function DiffNavigator_tokenStateAt_(ed) {
            ...
            var tokenIndex = tokens.findIndex(function (_ref) {
              ...
              return __varRecorder__$2.lessEqPosition(start, pos) && __varRecorder__$2.lessPosition(pos, end);
            });
          ...
          value: function DiffNavigator_findPatchEnd_(ed, pos) {
            var patch = this.findPatchAt(ed, pos);
            return patch ? __varRecorder__$2.arr.last(patch.tokens).end : pos;
          }
        }, {
          key: "findHunkStart",
          ...
          value: function DiffNavigator_findHunkEnd_(ed) {
            var pos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ed.cursorPosition;
            var hunk = this.findHunkAt(ed, pos);
            return hunk ? __varRecorder__$2.arr.last(hunk.tokens).end : pos;
          }
        }, {
          key: "backwardSexp",
          value: function DiffNavigator_backwardSexp_(ed) {
            ...
            if (__varRecorder__$2.obj.equals(pos, hunkStart)) {
              ed.saveExcursion(function () {
                ed.selection.goLeft();
                hunkStart = _this.findHunkStart(ed);
              });
              if (__varRecorder__$2.obj.equals(pos, hunkStart)) hunkStart = null;
            }

            if (__varRecorder__$2.obj.equals(pos, patchStart)) {
              ed.saveExcursion(function () {
                ed.selection.goLeft();
                patchStart = _this.findPatchStart(ed);
              });
              if (__varRecorder__$2.obj.equals(pos, patchStart)) patchStart = null;
            }
          ...
          value: function DiffNavigator_forwardSexp_(ed) {
            ...
            if (__varRecorder__$2.obj.equals(pos, hunkEnd)) {
              ed.saveExcursion(function () {
                ed.selection.goRight();
                hunkEnd = nav.findHunkEnd(ed);
              });
              if (__varRecorder__$2.obj.equals(pos, hunkEnd)) hunkEnd = null;
            }
          ...
          value: function DiffNavigator_forwardDownSexp_(ed) {
            __varRecorder__$2.show("Not yet implemented");
          }
        }, {
          ...
          value: function DiffNavigator_findContainingHunkOrPatchRange_(ed, startingRange) {
            ...
            var end = __varRecorder__$2.arr.last(toks).end;
      ...
      var __varRecorder__$1 = lively.FreezerRuntime.recorderFor("lively.ide/shell/git.js");

      function runCommands(_x) {
        return _runCommands.apply(this, arguments);
      }

      function _runCommands() {
        _runCommands = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(commands) {
          var results, group, i, _iterator, _step, _step$value, name, command, options, transform, readFile, writeFile, content, cmd;
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  results = {};
                  group = "lively.shell-default-command-group-" + __varRecorder__$1.string.newUUID();
                  i = 0;
                ...
                case 6:
                  ...
                  if (readFile) {
                    __varRecorder__$1.runCommand = readFileFn;
                    command = readFile;
                  } else if (writeFile) {
                    __varRecorder__$1.runCommand = writeFileFn;
                    command = writeFile;
                    options = options || {};
                  ...
                  _context.next = 15;
                  return __varRecorder__$1.runCommand(command, options);
      ...
      function runGitCommands(_x2) {
        return _runGitCommands.apply(this, arguments);
      }

      function _runGitCommands() {
        _runGitCommands = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(commands) {
          var options,
              defaultOptions,
              cwd,
              result,
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 6:
                  _context2.next = 8;
                  return __varRecorder__$1.defaultDirectory();
                ...
                case 14:
                  ...
                  result = Object.keys(result || {}).reduce(function (result, name) {
                    ...
                    result["cmd" + __varRecorder__$1.string.capitalize(name)] = cmd;
      ...
      function fileStatus(_x3) {
        return _fileStatus.apply(this, arguments);
      }

      function _fileStatus() {
        _fileStatus = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(dir) {
          var commands,
              mapping,
              lines,
              fileObjects,
      ...
      function applyPatchesFromEditor(_x4, _x5) {
        return _applyPatchesFromEditor.apply(this, arguments);
      }

      function _applyPatchesFromEditor() {
        _applyPatchesFromEditor = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(action, diffEditor) {
          var options,
              mode,
              hasSelection,
              patches,
              ...
              switch (_context4.prev = _context4.next) {
                ...
                case 4:
                  ...
                  if (!hasSelection) {
                    ...
                    _ref = patchInfo || {}, patch = _ref.patch, hunk = _ref.hunk;
      ...
      function applyPatches(_x6, _x7) {
        return _applyPatches.apply(this, arguments);
      }

      function _applyPatches() {
        _applyPatches = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(action, patches) {
          var options,
              args,
              commands,
              results,
              ...
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  commands = [{
                    name: "gitApply",
                    options: {
                      stdin: __varRecorder__$1.arr.invoke(patches, "createPatchString").join("\n")
                    },
      ...
      function stageOrUnstageOrDiscardFiles(_x8, _x9) {
        return _stageOrUnstageOrDiscardFiles.apply(this, arguments);
      }

      function _stageOrUnstageOrDiscardFiles() {
        _stageOrUnstageOrDiscardFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(action, fileObjects) {
          var options,
              filter,
              cmdGroups,
              commands,
              ...
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  cmdGroups = fileObjects.reduce(function (cmds, fo) {
                    ...
                    __varRecorder__$1.arr.invoke(groups, "push", fo.fileName);
      ...
      function _commit() {
        _commit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(opts) {
                ...
                case 0:
                  ...
                  commitCmd = function _commitCmd(message, author, email) {
                    ...
                    if (__varRecorder__$1.isPublicServer) {
                      ...
                      cmdString += __varRecorder__$1.string.format(" --author='%s <%s>'", author, email);
                    }
      ...
      __varRecorder__$1.defaultDirectory = defaultDirectory;
      __varRecorder__$1.runCommand = runCommand;
      ...
      var git = /*#__PURE__*/Object.freeze({
        __proto__: null,
        runGitCommands: runGitCommands,
        fileStatus: fileStatus,
        applyPatchesFromEditor: applyPatchesFromEditor,
        applyPatches: applyPatches,
        stageOrUnstageOrDiscardFiles: stageOrUnstageOrDiscardFiles,
        commit: commit
      });

      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.ide/diff/editor-plugin.js");

      function stageOrUnstagedOrDiscardAll(_x, _x2, _x3) {
        return _stageOrUnstagedOrDiscardAll.apply(this, arguments);
      }

      function _stageOrUnstagedOrDiscardAll() {
        _stageOrUnstagedOrDiscardAll = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(ed, action, options) {
          var mode, files, fos, selectedFos, _yield$__varRecorder_, commands, fileObjects;
            ...
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  ...
                  files = __varRecorder__.arr.pluck(mode.patches, "fileNameA");
                  _context12.next = 5;
                  return __varRecorder__.git.fileStatus(options.cwd, options);
                ...
                case 5:
                  ...
                  _context12.next = 9;
                  return __varRecorder__.git.stageOrUnstageOrDiscardFiles(action, selectedFos, options);

                case 9:
                  _yield$__varRecorder_ = _context12.sent;
                  commands = _yield$__varRecorder_.commands;
                  fileObjects = _yield$__varRecorder_.fileObjects;
                  ed.setStatusMessage(__varRecorder__.string.capitalize(action) + "\n" + __varRecorder__.arr.pluck(fileObjects, "fileName").join("\n"));
      ...
      function patchApplySelection(_x4, _x5, _x6) {
        return _patchApplySelection.apply(this, arguments);
      }

      function _patchApplySelection() {
        _patchApplySelection = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(ed, action, options) {
          var _yield$__varRecorder_2, commands, patches;
            ...
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  ...
                  _context13.next = 3;
                  return __varRecorder__.git.applyPatchesFromEditor(action, ed, options);

                case 3:
                  _yield$__varRecorder_2 = _context13.sent;
                  commands = _yield$__varRecorder_2.commands;
                  patches = _yield$__varRecorder_2.patches;
                  ed.setStatusMessage(__varRecorder__.string.capitalize(action) + "\n" + __varRecorder__.arr.invoke(patches, "createPatchString").join("\n"));
      ...
      __varRecorder__.DiffNavigator = DiffNavigator;
      __varRecorder__.DiffTokenizer = DiffTokenizer;
      __varRecorder__.FilePatch = FilePatch;
      __varRecorder__.EditorPlugin = EditorPlugin;
      __varRecorder__.runCommand = runCommand;
      __varRecorder__.git = git;

      var DiffEditorPlugin = exports('default', function (superclass) {
        var __lively_classholder__ = lively.FreezerRuntime.recorderFor("lively.ide/diff/editor-plugin.js");
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function DiffEditorPlugin_initialize_() {
            ...
            this.tokenizer = new __varRecorder__.DiffTokenizer();
            this.tokens = [];
            this.patches = [];
            return _this;
          }
          ...
          value: function DiffEditorPlugin_tokenize_(string) {
            ...
            if (string) {
              try {
                __varRecorder__.__inter0__ = this.tokenizer.tokenize(string), tokens = __varRecorder__.__inter0__.tokens, patches = __varRecorder__.__inter0__.patches;
              } catch (e) {}
            }
          ...
          value: function DiffEditorPlugin_tokenAt_(pos) {
            return this.tokens.find(function (_ref) {
              var start = _ref.start,
                  end = _ref.end;
              return __varRecorder__.lessEqPosition(start, pos) && __varRecorder__.lessEqPosition(pos, end);
            });
          }
        }, {
          key: "getNavigator",
          value: function DiffEditorPlugin_getNavigator_() {
            return new __varRecorder__.DiffNavigator();
          }
        }, {
          ...
          value: function DiffEditorPlugin_getPatchesFromSelection_(editor) {
            ...
            return patches.slice(from, to + 1).map(function (ea, i) {
              ...
              offset += ea.length();
              return patchString ? __varRecorder__.FilePatch.read(patchString) : null;
            }).filter(Boolean);
          }
        }, {
      ...
      __varRecorder__.commands = [{
        ...
        exec: function exec(ed) {
          ...
          if (!patches || !patches.length) {
            ...
            var patchString = __varRecorder__.arr.invoke(patches, "createPatchString").join("\n");
          }

          ed.world().execCommand("open text window", Object.assign({
            lineWrapping: "no-wrap",
            plugins: [new __varRecorder__.DiffEditorPlugin()]
          }, __varRecorder__.config.codeEditor.defaultStyle, {
            title: "patches for " + __varRecorder__.arr.pluck(patches, "fileNameA").join(", "),
            content: patchString,
            extent: __varRecorder__.pt(700, 400)
          }));
          return true;
        }
      }, {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 13:
                    ...
                    if (baseDir) {
                      filePath = __varRecorder__.string.joinPath(baseDir, filePath);
                    }

                  case 15:
                    if (lineNo) filePath += ":" + lineNo;
                    return _context.abrupt("return", ed.world().execCommand("open file", {
                      url: filePath
                    }));
        ...
        name: "[git] commit",
        exec: function () {
          var _exec2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.prev = 1;
                    _context2.next = 4;
                    return __varRecorder__.git.commit({
                      cwd: mode.cwd
                    });
        ...
        name: "[git] update",
        exec: function () {
          var _exec3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ed, args) {
            var input, mode, cmd;
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 6:
                    ...
                    _context3.next = 9;
                    return __varRecorder__.runCommand(input, {
                      cwd: mode.cwd
                    });
        ...
        exec: function () {
          var _exec4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
        ...
        exec: function () {
          var _exec5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
        ...
        exec: function () {
          var _exec6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
        ...
        exec: function () {
          var _exec7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
        ...
        exec: function () {
          var _exec8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
        ...
        name: "[git] stage all",
        exec: function () {
          var _exec9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
        ...
        exec: function () {
          var _exec10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
        ...
        exec: function () {
          var _exec11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(ed, args) {
            var mode;
            return regeneratorRuntime.wrap(function _callee11$(_context11) {
              while (1) {
                switch (_context11.prev = _context11.next) {
