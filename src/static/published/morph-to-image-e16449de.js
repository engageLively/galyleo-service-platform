System.register(['./__rootModule___commonjs-entry-2a340242.js'], (function (exports) {
  ...
  return {
    ...
    execute: (function () {
      ...
      exports('renderMorphToDataURI', renderMorphToDataURI);
          ...
          function newImage(element) {
            ...
            function inline(get) {
              ...
              return Promise.resolve(element.src).then(get || util.getAndEncode).then(function (data) {
                ...
                return new Promise(function (resolve, reject) {
                  element.onload = resolve; // for any image with invalid src(such as <img src />), just ignore it
      ...
      var __varRecorder__ = lively.FreezerRuntime.recorderFor("lively.morphic/rendering/morph-to-image.js");
      ...
      function renderMorphToDataURI(_x) {
        return _renderMorphToDataURI.apply(this, arguments);
      }

      function _renderMorphToDataURI() {
        _renderMorphToDataURI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(morph) {
          var opts,
              htmlMorphRestoreMap,
              actualRenderOnGPU,
              _morph$env$domEnv,
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 7:
                  ...
                  _context.next = 29;
                  return __varRecorder__.domToImage[method](canvas, {
                    style: {
                      transform: "scale(.7)",
      ...
      __varRecorder__.domToImage = exports$1$1;
