System.register(['./__rootModule___commonjs-entry-e09b514d.js', './loading-indicator.cp-4899d454.js'], (function (exports) {
...
;
  ...
  return {
    setters: [function (module) {
      ...
      morph = module.aH;
      ShadowObject = module.a6;
      Label = module.L;
      Path = module.be;
      sum = module.aR;
      levenshtein = module.aS;
      equals = module.Y;
      ...
      lines = module.aJ;
      compact = module.aB;
      LinearGradient = module.ac;
      easings = module.ah;
      without = module.ay;
      withoutAll = module.x;
      Ellipse = module.ak;
      add = module.a9;
      promise_finally = module.bm;
      keys = module.bF;
      min = module.aL;
      disconnect = module.n;
      Path$1 = module.a8;
      roundTo = module.bG;
      SystemTooltip = module.a_;
      isArray = module.a$;
      forEachOwn = module.bH;
      safeToString = module.bI;
      nameFor = module.bJ;
      _missingExportShim = module.bK;
      addClassMappings = module.bL;
    }, function (module) {
