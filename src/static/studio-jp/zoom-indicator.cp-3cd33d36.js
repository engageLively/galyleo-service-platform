System.register(['./__rootModule___commonjs-entry-99f49744.js'], (function (exports) {
  var __contextModule__ = typeof module !== 'undefined' ? module : arguments[1];
;
  var initializeClass, pt, ViewModel, component, Color, TilingLayout, Text, Icon;
  return {
      ...
      (function (superclass) {
        ...
        return initializeClass(__lively_class__, superclass, [{
          ...
          value: function WorldZoomIndicatorModel_relayout_() {
            ...
            if ($world.activeSideBars.includes("properties panel")) view.position = pt($world.get("properties panel").left - 10 - view.width - miniMapOffset, $world.extent.y - 10 - view.height);else this.view.position = pt($world.extent.x - view.width - 10 - miniMapOffset, $world.extent.y - view.height - 10);
          }
        }], [{
