System.register(['./__rootModule___commonjs-entry-e09b514d.js'], (function (exports, module) {
...
;
  ...
  return {
    setters: [function (module) {
      ...
      comparePosition = module.go;
      lessEqPosition = module.gm;
      last = module.q;
      applyChanges = module.fG;
      ViewModel = module.V;
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return module.import('./occur-11bcd469.js');
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 3;
                    return module.import('./search.cp-4c68afe1.js');
