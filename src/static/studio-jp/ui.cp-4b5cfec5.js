System.register(['./__rootModule___commonjs-entry-155b3e75.js', './ui.cp-b8e91d73.js', './index-1a6ff12a.js', './object-classes-238ef1a8.js', './index-a131a103.js', './index-dc24eb07.js', './app-db8ee346.js', './client-07e8570b.js', './messages.cp-01fa479b.js', './loading-indicator.cp-766d8c22.js', './list.cp-b4c3f89d.js', './editor-modes-219f06c3.js', './search-f050fd43.js', './shell-interface-f849d9b6.js', './client-command-4a3ff0cc.js', './index-e7981589.js', './events-fb04d05d.js', './code-search.cp-de3b236a.js', './client-resource-11df9029.js', './editor-plugin-f37ef188.js', './dialogs.cp-f02a8261.js', './canvas-dc7c39ea.js', './morph-to-image-ae9ef2e9.js'], (function (exports, module) {
  var __contextModule__ = typeof module !== 'undefined' ? module : arguments[1];
;
  var initializeClass, without, withSuperclasses, _toConsumableArray, Icon, isString, unsubscribe, keys, _asyncToGenerator, subscribe, getClassName, isArray, isObject, deserialize, waitFor, isFunction, hashCode, isClass, Path, isNumber, between, Color, debounceNamed, config, ViewModel, _slicedToArray, pt, delay, capitalize, adoptObject, Morph, resource, debounce, pluck, _createForOfIteratorHelper, values, truncate, part, dissoc, component, GridLayout, TilingLayout, Text, rect, l2lInterfaceFor, localInterface, chooseUnusedImports, generateReferenceExpression, JavaScriptEditorPlugin, interactivelyFreezePart, InteractiveMorphSelector, DefaultTheme, DarkTheme, lint, interactivlyFixUndeclaredVariables, interactivelyChooseImports, TreeData, Tree, lexicalClassMembers, RuntimeSourceDescriptor, isObjectClass, interactivelyForkPackage, addScript, ObjectPackage, stringifyFunctionWithoutToplevelRecorder, modules, module$1, parse, topLevelDeclsAndRefs, nodesInScopeOf, exports$1, L2LClient, StatusMessageError, StatusMessageWarning, StatusMessageConfirm, open$1, SystemButton, DefaultList;
  return {
    setters: [function (module) {
      initializeClass = module.i;
      without = module.ay;
      withSuperclasses = module.f$;
      ...
      subscribe = module.aV;
      getClassName = module.b0;
      isArray = module.a$;
      isObject = module.bO;
      deserialize = module.gC;
      waitFor = module.am;
      isFunction = module.eb;
      hashCode = module.bY;
      isClass = module.gD;
      Path = module.be;
      isNumber = module.fY;
      ...
      l2lInterfaceFor = module.aG;
      localInterface = module.T;
      chooseUnusedImports = module.aH;
      generateReferenceExpression = module.aI;
      JavaScriptEditorPlugin = module.aJ;
      interactivelyFreezePart = module.aK;
      InteractiveMorphSelector = module.aF;
      DefaultTheme = module.aL;
      DarkTheme = module.aM;
      lint = module.aN;
      interactivlyFixUndeclaredVariables = module.aO;
      interactivelyChooseImports = module.aP;
    }, function (module) {
      TreeData = module.T;
      Tree = module.r;
    }, function (module) {
                            ...
                            while (1) {
                              switch (_context55.prev = _context55.next) {
                                ...
                                case 3:
                                  ...
                                  _context55.next = 6;
                                  return module.import('./index-a131a103.js').then(function (n) { return n.m; });
